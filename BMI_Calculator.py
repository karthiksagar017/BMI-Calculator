...
def BMI():
    ...
    if bmi<=18.5:
        ...
        label3.config(text="It Indicates that You are healthier!")

    elif bmi>25 and bmi<=30:
        label2.config(text="overweight")
        label3.config(text="It Indicates You are slightly overweight")

    else:
        label2.config(text="obes")
        label3.config(text="health may be at risk please visit doctor!")
...
label4=Label(root, text="Height", font="arial 10 bold",bg="white" ,fg="black")
label4.place(x=100,y=120)

label5=Label(root, text="Weight", font="arial 10 bold",bg="white", fg="black")
label5.place(x=320,y=120)
